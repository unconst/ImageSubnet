...
parser.add_argument('--subtensor._mock', action="store_true", help="use mock subtensor for local testing")
parser.add_argument('--validator.allow_nsfw', action="store_true", help="allow nsfw images to be queried")
parser.add_argument('--validator.save_dir', type=str, default='./images')
parser.add_argument('--validator.save_images', action="store_true", help="save images to save_dir")
parser.add_argument('--validator.ignore_absolute_size', action="store_true", help="ignore absolute size and instead match by aspect ratio")
parser.add_argument('--validator.use_absolute_size', action="store_false", help="(DEPRECATED) use absolute size instead of matching aspect ratio")
